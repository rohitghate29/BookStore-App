...
function Navbar() {
  ...
  return (
    <>
      <div
        className={`z-10 max-w-screen-2xl mx-auto container md:px-20 px-4 fixed top-0 left-0 right-0 ${
          sticky
            ? "shadow-md bg-base-200 duration-300 transition-all ease-in-out dark:bg-slate-900"
            : ""
        }`}
      >
